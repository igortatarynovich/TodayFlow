...
Каноны экрана Сегодня и связанные контракты.

| Файл | Роль |
|------|------|
| [TODAY_INFORMATION_CONTRACT_V1.md](./TODAY_INFORMATION_CONTRACT_V1.md) | **Закрытое N Today** — 8 вводов · 16 фактов · 20 allowed knowledge; code gate |
...
| [../status/TODAY_INFORMATION_CONTRACT_HANDOFF.md](../status/TODAY_INFORMATION_CONTRACT_HANDOFF.md) | Next agent: coverage 20 COMPLETE / 0 PARTIAL; next = TIC close-out, not K21 |
