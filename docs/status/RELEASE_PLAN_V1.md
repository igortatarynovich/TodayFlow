...
| 1.6 | Parallel: Practice Library fill | +1 sourced P0 cell per week starting from `need.decision_making.focus` | 0.1 |
...
| # | Task | Acceptance Criteria | Depends On |
|---|------|---------------------|------------|
| 3.1 | Practice Library 26/26 sourced | `content_coverage_matrix_v1.json`: 26 covered, 0 seed; `content_library_v1.json` not `llm_provisional` — **15/26 covered 2026-08-29** (`need.creativity.open` sourced via `technique.creative_prompt`; next cell `need.decision_making.focus`) | 1.6 |
...
|-------|----------|---------------|
| Practice Library fill | 1 cell / week | Phase 0 | // now at 15/26, next `need.decision_making.focus`
