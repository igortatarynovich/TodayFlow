...
**Profile application:** [PROFILE_PRODUCT_SURFACE_CANON.md](profile/PROFILE_PRODUCT_SURFACE_CANON.md) · [PROFILE_PRODUCT_JOURNEY_FORMS_V1.md](profile/PROFILE_PRODUCT_JOURNEY_FORMS_V1.md) · [PROFILE_DISPLAY_INVENTORY_V1.md](profile/PROFILE_DISPLAY_INVENTORY_V1.md)  
**Today application:** [TODAY_PRODUCT_FLOW_V1.md](today/TODAY_PRODUCT_FLOW_V1.md) · [TODAY_DISPLAY_INVENTORY_V1.md](today/TODAY_DISPLAY_INVENTORY_V1.md)  
**Construction law:** [DISPLAY_CONSTRUCTION_GRAMMAR_V1.md](foundation/DISPLAY_CONSTRUCTION_GRAMMAR_V1.md)  
