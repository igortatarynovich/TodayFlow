...
- Менять архитектуру Interpretation Library, пока не зафиксировано разделение Product Canon / Lenses (IL 1.3.76). После фиксации — не открывать книги; Mainstream planet map = 1.3.77; grammar = 1.3.78; Planet Canon V1 = 1.3.79; storage = 1.3.80; Sun–Saturn fill = 1.3.81; smoke-test = 1.3.82; Signs Mainstream map = 1.3.83; Sign Canon grammar = 1.3.84; Sign Canon fill = 1.3.85; Sign Canon storage = 1.3.86; Sign Canon materialization = 1.3.87; Planet × Sign smoke-test = 1.3.88; Houses Mainstream map = 1.3.89; House Canon grammar = 1.3.90; следующий проход = House Canon fill.
...
- **1.18 (2026-08-22)** — IL-1.3.90: House Canon grammar. One slot (`arena`). Next = House Canon fill.
