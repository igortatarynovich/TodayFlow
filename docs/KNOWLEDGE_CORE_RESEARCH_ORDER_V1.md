...
- Менять архитектуру Interpretation Library, пока не зафиксировано разделение Product Canon / Lenses (IL 1.3.76). После фиксации — не открывать книги; Mainstream planet map = 1.3.77; grammar = 1.3.78; Planet Canon V1 = 1.3.79; storage = 1.3.80; Sun–Saturn fill = 1.3.81; smoke-test = 1.3.82; следующий проход = Signs Mainstream map for Sign Canon grammar.
...
- **1.10 (2026-08-21)** — IL-1.3.82: composition smoke-test. Aspect PASS. Sign/house PARTIAL. Next = Signs Mainstream for Sign Canon grammar.
