...
- Менять архитектуру Interpretation Library, пока не зафиксировано разделение Product Canon / Lenses (IL 1.3.76). После фиксации — не открывать книги; Mainstream planet map = 1.3.77; grammar = 1.3.78; следующий проход = 1.3.79 fill, не schema.
...
- **1.6 (2026-08-21)** — IL-1.3.78: Planet Canon grammar. Six slots. tempo = Foundation. Next = 1.3.79 fill, not schema.
