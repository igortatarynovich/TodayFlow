...
| [PRACTICE_CONTENT_COVERAGE_V1.md](./PRACTICE_CONTENT_COVERAGE_V1.md) | **Coverage** (v1.11): 26/26 P0 cells · type spine. Architecture stands. Sourced 15/26. Next cell = `need.decision_making.focus` |
...
| [PRACTICE_TECHNIQUE_PROVENANCE_V1.md](./PRACTICE_TECHNIQUE_PROVENANCE_V1.md) | **SoT происхождения техники** (v1.22): одна запись на технику. LLM не источник метода. Meaning не знает `item_id` / `technique_id` |
