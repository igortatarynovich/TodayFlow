...
| [PRACTICE_CONTENT_COVERAGE_V1.md](./PRACTICE_CONTENT_COVERAGE_V1.md) | **Fill-pass** (v1.0): coverage-first · ledger-order seeds · 2/26 P0 cells. Next empty = `need.focus.focus` |
