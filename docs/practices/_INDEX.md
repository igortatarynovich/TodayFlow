...
| [PRACTICE_CONTENT_COVERAGE_V1.md](./PRACTICE_CONTENT_COVERAGE_V1.md) | **Coverage** (v1.9): 26/26 P0 cells · type spine. Architecture stands. Sourced 13/26. Next cell = `need.connection.connect` |
...
| [PRACTICE_TECHNIQUE_PROVENANCE_V1.md](./PRACTICE_TECHNIQUE_PROVENANCE_V1.md) | **SoT происхождения техники** (v1.20): одна запись на технику. LLM не источник метода. Meaning не знает `item_id` / `technique_id` |
