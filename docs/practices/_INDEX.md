...
| [PRACTICE_CONTENT_COVERAGE_V1.md](./PRACTICE_CONTENT_COVERAGE_V1.md) | **Coverage** (v1.22): 26/26 P0 cells · type spine. Architecture stands. All 26 P0 need cells sourced. P1: 20/42 **STOPPED** (5 skipped). Remaining P1 waits on product demand |
| [PRACTICE_LIBRARY_FILL_V1.md](./PRACTICE_LIBRARY_FILL_V1.md) | **Fill process** (parked): lightweight provenance. P1 train STOPPED 2026-09-20 |
