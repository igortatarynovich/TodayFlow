...
| [PRACTICE_CONTENT_COVERAGE_V1.md](./PRACTICE_CONTENT_COVERAGE_V1.md) | **Coverage** (v1.15): 26/26 P0 cells · type spine. Architecture stands. Sourced 19/26. Next cell = `need.self_control.stabilize` |
...
| [PRACTICE_TECHNIQUE_PROVENANCE_V1.md](./PRACTICE_TECHNIQUE_PROVENANCE_V1.md) | **SoT происхождения техники** (v1.26): одна запись на технику. LLM не источник метода. Meaning не знает `item_id` / `technique_id` |
