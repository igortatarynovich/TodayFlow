...
| [PRACTICE_CONTENT_COVERAGE_V1.md](./PRACTICE_CONTENT_COVERAGE_V1.md) | **Coverage** (v1.22): 26/26 P0 cells · type spine. Architecture stands. All 26 P0 need cells sourced. P1: 6/42. Next = `practice.shaking_release` |
