...
1. Ingest стоит. Canon пуст. Type не attested.
2. Следующий named pass: **Normalization V1** — позволяют ли эти три записи один canonical kernel, или landscape family нужно разделить. Не следующая shortlist-семья.
