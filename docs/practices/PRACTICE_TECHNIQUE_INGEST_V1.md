...
1. Ingest стоит. Normalization V1 = `insufficient_evidence`. Canon пуст. Type не attested.
2. Следующий named pass: **targeted shortlist** на identity post-exhale hold. Не Safety Review.
