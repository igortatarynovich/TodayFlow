...
**Версия:** 1.74 (2026-09-20) — P1 fill STOPPED at 20/42; remaining P1 waits on product demand. Lightweight fill process stands; Content Library wired to hub via `content_library_selection_v1.py`; all 26 P0 need cells sourced; P1 coverage: 20/42; affirmation.permission skipped; affirmation.self_worth skipped; affirmation.self_identity skipped; meditation.silence skipped; meditation.walking_meditation accepted; meditation.gratitude accepted; meditation.self_compassion accepted; meditation.loving_kindness accepted; meditation.visualization accepted; release_ritual accepted; music accepted; drawing accepted; boundary_action accepted; future_self accepted; practice_visualization accepted; review accepted; practice_gratitude accepted; shaking_release accepted; walking accepted; mindful_movement accepted; stretching accepted; practice.body_scan skipped; practice_grounding accepted; physiological_sigh accepted; paced_breathing accepted; consumption_limit accepted; digital_limit accepted; relationship accepted; agency accepted; reflection_meditation accepted; letting_go accepted; grounding accepted; open_awareness accepted; body_scan accepted; breath_awareness accepted; evening_ritual accepted; morning_ritual accepted; free_writing accepted; environment_reset accepted; intention_setting accepted; mindfulness accepted; digital_pause accepted; reduction accepted; consistency_challenge accepted; acceptance accepted; abstinence skipped_for_now; attention_discipline accepted; routine_commitment accepted; progressive_relaxation accepted; transition_ritual accepted; priority_setting accepted; creative_prompt accepted; connection_action accepted; journaling accepted; self_check_in accepted; micro_action accepted; sleep_discipline accepted; sleep accepted; relaxation accepted; body_release accepted; capability accepted; self_trust skipped; research ladder archived, non-blocking.  
...
| Дата | Изменение |
|------|-----------|
| 2026-09-20 | v1.74 — P1 fill train STOPPED at 20/42 sourced, 5 skipped. Remaining P1 types wait on product demand. Next product work is Profile knowledge-to-output, not `affirmation.acceptance`. |
| 2026-09-20 | v1.73 — `technique.permission` skipped (`source_gap`). No brief spoken inner «I am allowed to X» method. NHS/Mind saying no or taking a break is `boundary_action` or a rest action; CCI «deserve a break» is already self_compassion; slogans and assertiveness rights-lists are not a method. P1 coverage: 20/42 sourced, 5 P1 skipped. Next = `affirmation.acceptance`. |
| 2026-09-20 | v1.72 — `technique.self_worth` skipped (`source_gap`). No brief spoken «worth is not this result» method. CCI pie / self-esteem modules are workbooks; NHS is a five-item list and thought-challenge; Mind «I am enough» is a slogan; kind voice is already self_compassion; coping is already capability. P1 coverage: 20/42 sourced, 4 P1 skipped. Next = `affirmation.permission`. |
| 2026-09-20 | v1.71 — `technique.self_identity` skipped (`source_gap`). No brief spoken «I can remain myself» method in official_health / educational sources. Steele/Cohen is values-writing (already agency/relationship); CCI/NHS self-esteem is worth/esteem work; slogan repetition is not a method. Capability and agency already cover coping and choice. P1 coverage: 20/42 sourced, 3 P1 skipped. Next = `affirmation.self_worth`. |
| 2026-09-20 | v1.70 — `technique.silence` skipped (`family_collapse`). NHS Scotland MBSR choiceless awareness / just sitting is open monitoring (`technique.open_awareness`); unguided sitting is delivery of breath/mindfulness; silent-day / noble silence is `discipline.silence`. No distinct meditation-class kernel. P1 coverage: 20/42 sourced, 2 P1 skipped. Next = `affirmation.self_identity`. |
| 2026-09-19 | v1.69 — `technique.walking_meditation` accepted (Guy's and St Thomas' NHS MBSR walking mindfulness + Newcastle Hospitals NHS walking meditation + RUH Bath PHY051 Mindful Walking). Brief slow loop with attention on lift–move–land; not practice.walking/mindful_movement/sitting breath. Not a workout, nature walk, MBSR course, or treatment. `meditation.walking_meditation.001` active. P1 coverage: 20/42 sourced. Next = `meditation.silence`. |
| 2026-09-19 | v1.68 — `technique.gratitude` accepted (GGIA Kemper / Ohio State Gratitude Meditation + OSU Wexner Heart-Centered Gratitude + Sussex Mindfulness Centre NHS small thankful details). Brief sit with one ordinary thankful fact; not practice.gratitude/loving_kindness/mindfulness. Not Three Good Things, journal, or treatment. `meditation.gratitude.001` active. P1 coverage: 19/42 sourced. Next = `meditation.walking_meditation`. |
| 2026-09-19 | v1.67 — `technique.self_compassion` accepted (KMPCT NHS stress handbook + SE Trust HSCNI Using Self Compassion + CCI WA Health Barriers to Self-Compassion). Brief supporting voice toward yourself in difficulty; not loving_kindness/acceptance/affirmation.compassion/journaling. Not full MSC curriculum, CFT, or treatment. `meditation.self_compassion.001` active. P1 coverage: 18/42 sourced. Next = `meditation.gratitude`. |
| 2026-09-19 | v1.66 — `technique.loving_kindness` accepted (NHS Scotland Right Decisions actual practice + NHS Lothian Loving Kindness meditation + BSMHFT sending kind thoughts). Brief well-wishing to self then one person; not self_compassion/connection_action/meditation.gratitude. Not full MBSR four-circle protocol, CFT, or treatment. `meditation.loving_kindness.001` active. P1 coverage: 17/42 sourced. Next = `meditation.self_compassion`. |
| 2026-09-18 | v1.65 — `technique.visualization` accepted (NHS Inform Visualisation exercise + CUH NHS guided imagery + Oxford Health CAMHS Visualisation). Brief calm-place image; not practice.visualization/future_self/intention_setting. Not full clinical guided-imagery protocol, manifestation, or treatment. `meditation.visualization.001` active. P1 coverage: 16/42 sourced. Next = `meditation.loving_kindness`. |
| 2026-09-17 | v1.64 — `technique.release_ritual` accepted (ELFT NHS Dealing with Worry + MindWell Leeds Taking control of stress + University of Exeter CEDAR Problem Solving). Brief write-and-aside close; not transition_ritual/evening_ritual/meditation.letting_go. Not full worry-time protocol, fire rites, or treatment. `practice.release_ritual.001` active. P1 coverage: 15/42 sourced. Next = `meditation.visualization`. |
| 2026-09-17 | v1.63 — `technique.music` accepted (NHS Every Mind Matters low mood + sleep tips + Mind Relaxation Listen to music). Brief one-track listen; not drawing/creative_prompt/session accompaniment. Not music therapy, playlist programme, or sleep protocol. `practice.music.001` active. P1 coverage: 14/42 sourced. Next = `practice.release_ritual`. |
| 2026-09-17 | v1.62 — `technique.drawing` accepted (CUH NHS Sketch Appeal + Calderdale and Kirklees Recovery College mindful drawing + Greater Good in Education Drawing as a Way to Manage Emotions). Brief freehand sketch; not creative_prompt/free_writing/music. Not art class, Zentangle curriculum, or art therapy. `practice.drawing.001` active. P1 coverage: 13/42 sourced. Next = `practice.music`. |
| 2026-09-17 | v1.61 — `technique.boundary_action` accepted (NHS Every Mind Matters work-related stress + Mind Practise saying no + Leicestershire Partnership NHS Assertiveness). Brief one decline; not micro_action/connection_action/digital_pause/digital_limit. Not assertiveness curriculum, broken-record, rights lists, or treatment. `practice.boundary_action.001` active. P1 coverage: 12/42 sourced. Next = `practice.drawing`. |
| 2026-09-02 | v1.60 — `technique.future_self` accepted (University of Edinburgh Reflection Toolkit + Greater Good Best Possible Self / King 2001 + Hershfield 2011). Brief later-self image; not intention_setting/visualization/journaling. Not BPS writing protocol, letter programme, or manifestation. `practice.future_self.001` active. P1 coverage: 11/42 sourced. Next = `practice.boundary_action`. |
| 2026-08-31 | v1.59 — `technique.practice_visualization` accepted (UHD NHS Mental Practice + Feltz & Landers 1983 + Holmes & Collins 2001). Brief mental rehearsal of one upcoming action; not intention_setting/future_self/meditation.visualization. Not GMI/stroke rehab/manifestation. `practice.visualization.001` active. P1 coverage: 10/42 sourced. Next = `practice.future_self`. |
| 2026-08-31 | v1.58 — `technique.review` accepted (NHS Transformation Partners End of Shift Wellbeing Checklist + UH Bristol reflective writing + NHS Borders look back). Brief two-pole look-back of today or one event; not journaling/prompted_reflection/gratitude/self_check_in/evening_ritual. Not Gibbs/AAR. `practice.review.001` active. P1 coverage: 9/42 sourced. Next = `practice.visualization`. |
| 2026-08-31 | v1.57 — `technique.practice_gratitude` accepted (NHS 10 stress busters + Every Mind Matters stress + Greater Good Three Good Things). Brief constrained list of three things that went well or that you are thankful for; not journaling/prompted_reflection/meditation.gratitude. `practice.gratitude.001` active. P1 coverage: 8/42 sourced. Next = `practice.review`. |
| 2026-08-31 | v1.56 — `technique.shaking_release` accepted (Cardiff and Vale UHB NHS Wales sedentary-worker micro-pause + West Suffolk NHS loosening + UMass Memorial workstation arm shake). Brief voluntary shake-out, not body_release/mobility/stretch/TRE. `practice.shaking_release.001` active. P1 coverage: 7/42 sourced. Next = `practice.gratitude`. |
| 2026-08-31 | v1.55 — `technique.walking` accepted (NHS sit less + Better Health get active + NHS England corridor/2-minute walk). Brief locomotion sit-break, not mobility/mindful_movement/walking_meditation. `practice.walking.001` active. P1 coverage: 6/42 sourced. Next = `practice.shaking_release`. |
| 2026-08-31 | v1.54 — `technique.mindful_movement` accepted (Sussex Mindfulness Centre NHS + UHDB NHS + RUH Bath PHY051). Brief movement-with-attention, not mobility/stretch/sit-mindfulness/walk. `practice.mindful_movement.001` active. P1 coverage: 5/42 sourced. Next = `practice.walking`. |
| 2026-08-31 | v1.53 — `technique.practice_body_scan` skipped (`family_collapse` with meditation `technique.body_scan`). `technique.stretching` accepted (NHS Flexibility + Sitting exercises). Brief hold-stretch, not mobility and not PMR. `practice.stretching.001` active. P1 coverage: 4/42 sourced. Next = `practice.mindful_movement`. |
| 2026-08-31 | v1.52 — `technique.practice_grounding` accepted (Royal Berkshire NHS + Singh et al. 2003 Soles of the Feet). Brief feet-press / sole-contact action; distinct from sensory_grounding and meditation.grounding. `practice.grounding.001` active. P1 coverage: 3/42. Next = `practice.body_scan`. |
| 2026-08-31 | v1.51 — `technique.physiological_sigh` accepted (Vlemincx et al. 2010 + KU Leuven resetter hypothesis + instructed-sigh relief). Two consecutive nasal inhales (second smaller), long exhale through mouth; a few comfortable repetitions. `practice.physiological_sigh.001` active. P1 coverage: 2/42. Next = `practice.grounding`. |
| 2026-08-31 | v1.50 — P1 coverage starts; `technique.paced_breathing` accepted (NHS Bradford District Care Trust Ready to Relate + Harvard Health). Slow, steady breath (~5–6/min), inhale nose, exhale slightly longer, no hold. `practice.paced_breathing.001` active. P1 coverage: 1/42. Next = `practice.physiological_sigh`. |
| 2026-08-31 | v1.49 — Content Library runtime bridge live: `content_library_selection_v1.py` serves active/accepted items through `GET /practices` and `GET /practices/{id}`; hub catalog expands from 47 to 47+111 items. No new technique accepted. Next = density pass or skipped-type reassessment on product demand |
| 2026-08-30 | v1.48 — `technique.consumption_limit` accepted (The Independent 48-hour rule + Shah et al. 2023 planning prompts); P0 type coverage: 40/44 P0 spine types sourced; all non-skipped P0 spine types sourced; next = P1 type coverage / density / skipped reassessment decision |
| 2026-08-30 | v1.47 — `technique.digital_limit` accepted (NHS London Waiting Room + Google Android Digital Wellbeing); P0 type coverage: 39/44 P0 spine types sourced; next = `discipline.consumption_limit` |
...
| 2026-08-30 | v1.42 — `technique.grounding` accepted (NHS inform + Royal Berkshire NHS); P0 type coverage: 34/44 P0 spine types sourced; next = `meditation.letting_go` |
| 2026-08-30 | v1.41 — `technique.open_awareness` accepted (Lutz et al. 2008 + Mindful.net); P0 type coverage: 33/44 P0 spine types sourced; next = `meditation.grounding` |
| 2026-08-30 | v1.40 — `technique.body_scan` accepted (NHS Scotland Right Decisions + Guy's and St Thomas' NHS MBSR exercises); P0 type coverage: 32/44 P0 spine types sourced; next = `meditation.open_awareness` |
| 2026-08-30 | v1.39 — `technique.breath_awareness` accepted (NHS Mindfulness + Guy's and St Thomas' NHS MBSR exercises); P0 type coverage: 31/44 P0 spine types sourced; next = `meditation.body_scan` |
