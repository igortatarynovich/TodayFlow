...
1. Targeted shortlist закрыт. Canon пуст. Type не attested.
2. Следующий named pass: **targeted ingest** двух selected resolution loci, затем **Normalization V1.1**.
3. Safety Review — только после будущего `normalize_one`.
