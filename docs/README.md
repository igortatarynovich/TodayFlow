...
- [astrology/KNOWLEDGE_CORE_V1_FREEZE.md](./astrology/KNOWLEDGE_CORE_V1_FREEZE.md) — **Knowledge Core V1 FREEZE (1.3.106):** five stored families = V1 atoms. Catalog 38 draft / 0 active. IL-2 **done 1.3.107**. IL-3 **done 1.3.108**. IL-4 **done 1.3.109**. Library scale **done 1.3.110**. Wire calc → IL **done 1.3.111**. Next = attach IL-4 packs to product surfaces
- [astrology/IL2_COMPOSITION_RULES_V1.md](./astrology/IL2_COMPOSITION_RULES_V1.md) — **IL-2 composition rules (1.3.107):** role weights, conflict, merge. Not a pair catalog. IL-3 **done 1.3.108**. IL-4 **done 1.3.109**. Library scale **done 1.3.110**. Wire **done 1.3.111**. Next = attach IL-4 packs to product surfaces
- [astrology/IL3_INTERPRETATION_ENGINE_V1.md](./astrology/IL3_INTERPRETATION_ENGINE_V1.md) — **IL-3 Interpretation Engine (1.3.108):** sky-internal theme rank. Not user relevance. IL-4 **done 1.3.109**. Library scale **done 1.3.110**. Wire **done 1.3.111**. Next = attach IL-4 packs to product surfaces
- [astrology/IL4_EXPRESSION_V1.md](./astrology/IL4_EXPRESSION_V1.md) — **IL-4 Expression (1.3.109):** voice for already chosen themes. Not meaning. Library scale **done 1.3.110**. Wire **done 1.3.111**. Next = attach IL-4 packs to product surfaces
- [astrology/LIBRARY_SCALE_V1.md](./astrology/LIBRARY_SCALE_V1.md) — **Library scale (1.3.110):** V1 coverage contract. 616 composed cells. Wire live at library layer 1.3.111. Next = attach IL-4 packs to product surfaces
- [astrology/CALC_IL_WIRE_V1.md](./astrology/CALC_IL_WIRE_V1.md) — **Calc → IL wire (1.3.111):** library layer. Product surfaces not attached. Next = attach IL-4 packs to product surfaces
