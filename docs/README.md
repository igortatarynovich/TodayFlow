...
**Today closed N:** [today/TODAY_INFORMATION_CONTRACT_V1.md](./today/TODAY_INFORMATION_CONTRACT_V1.md) — 8 вводов · 16 фактов · 20 allowed knowledge. **CLOSED / PASS**. Не второй I0.  
...
- [today/TODAY_INFORMATION_CONTRACT_V1.md](./today/TODAY_INFORMATION_CONTRACT_V1.md) — **закрытое N Today — CLOSED / PASS**
...
3. [TODAY_SCREEN_V1_CANON.md](./TODAY_SCREEN_V1_CANON.md) · [today/TODAY_PRODUCT_FLOW_V1.md](./today/TODAY_PRODUCT_FLOW_V1.md) — experience / product cycle (подчинены п.2 для смысла; нарезка экрана — PRODUCT_FLOW). **X3 CLOSED / PASS.** **X4/X5 CLOSED / PASS.** Next Today remainder = P1 X11 leftover, then X14; не Compatibility N.
