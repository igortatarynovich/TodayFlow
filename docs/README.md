...
- [KNOWLEDGE_CORE_RESEARCH_ORDER_V1.md](./KNOWLEDGE_CORE_RESEARCH_ORDER_V1.md) — **порядок семантического ядра.** **Астрология IL (1.3.106):** Knowledge Core V1 FREEZE. Five stored families = V1 atoms. STOP Angles. 1.3.105 final atomic smoke. 1.3.104 Planet×Angle smoke. 1.3.103 storage. 1.3.102 fill. 1.3.101 grammar (`orientation`). 1.3.100 Mainstream Angle map. 1.3.99 orientation loci. 1.3.98 stored Planet × Aspect smoke PASS. STOP Aspects. Houses closed (1.3.93). Next = IL-2 composition rules. Исторический корпус = lenses
...
- [astrology/KNOWLEDGE_CORE_V1_FREEZE.md](./astrology/KNOWLEDGE_CORE_V1_FREEZE.md) — **Knowledge Core V1 FREEZE (1.3.106):** five stored families = V1 atoms. Catalog 38 draft / 0 active. Next = IL-2
