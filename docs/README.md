...
- [KNOWLEDGE_CORE_RESEARCH_ORDER_V1.md](./KNOWLEDGE_CORE_RESEARCH_ORDER_V1.md) — **порядок семантического ядра.** **Астрология IL (1.3.100):** Mainstream Angle map locked. 1.3.99 orientation loci. 1.3.98 stored Planet × Aspect smoke PASS. STOP Aspects. Houses closed (1.3.93). Next = Angle Canon grammar. Исторический корпус = lenses
