...
`day-scenario-native-c4.1` — IL-4 consume: protected `IL4_MEANING` prefix + dramaturgy brief SoT + reject-invalid on voiced refused lemmas.  
Prior: `c4.0` (dramaturgy brief + protected user message) · `c3.3b` · `c3.3a` · `c3.2` · `c3.1` · `c1.0`.  
