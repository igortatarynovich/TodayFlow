# TodayFlow — Product Canon (Unified v1.11)
...
- единственный authority о человеке; астрологический смысл — IL; personal meaning — только композиция.
...
Не «астро-экран» и не семь зон. Живые поверхности — ровно четыре, канон: [TODAY_PRODUCT_FLOW_V1](./today/TODAY_PRODUCT_FLOW_V1.md).
...
Цвет, практика, цели, трекинг — не отдельные зоны и не новые шаги: тап / sheet внутри поверхностей.
...
| 2026-08-21 | v1.11 — §2: Personal Model = authority о человеке (IL = астрология; personal meaning = композиция); §3.3: четыре поверхности FLOW_V1, не семь зон |
