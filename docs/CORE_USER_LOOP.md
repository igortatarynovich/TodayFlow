...
**Связь:** [FIRST_DAY_EXPERIENCE.md](./FIRST_DAY_EXPERIENCE.md), [TODAY_PRODUCT_MODEL.md](./TODAY_PRODUCT_MODEL.md), [USER_MODEL_TARGET_STATE.md](./USER_MODEL_TARGET_STATE.md), [API_MEMORY_AND_LEARNING_LAYER.md](./API_MEMORY_AND_LEARNING_LAYER.md), [PERSONAL_INTELLIGENCE_LAYER.md](./PERSONAL_INTELLIGENCE_LAYER.md).
...
Today — **главный продукт**. Profile — **Personal Operating Manual**, улучшающий качество Today. См. [PROFILE_SCREEN_MASTER.md](./PROFILE_SCREEN_MASTER.md) §0.1.
...
| Документ | Роль |
|----------|------|
| [PROFILE_SCREEN_MASTER.md](./PROFILE_SCREEN_MASTER.md) | **Центральный объект** — источник контекста |
...
| [PROFILE_SCREEN_MASTER.md](./PROFILE_SCREEN_MASTER.md) | **UI + контент** Profile |
| [USER_MODEL_TARGET_STATE.md](./USER_MODEL_TARGET_STATE.md) | Intelligence artifact **behind** loop |
