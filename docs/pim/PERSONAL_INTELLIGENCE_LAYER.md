...
**Связь:** [USER_MODEL_TARGET_STATE.md](./USER_MODEL_TARGET_STATE.md) (4 выхода, CUM), [USER_KNOWLEDGE_MODEL.md](./USER_KNOWLEDGE_MODEL.md), [INTERPRETATION_LAYER_AND_REFERENCE.md](../explainability/INTERPRETATION_LAYER_AND_REFERENCE.md), [PERSONAL_INTELLIGENCE_LAYER.md](./PERSONAL_INTELLIGENCE_LAYER.md), [API_MEMORY_AND_LEARNING_LAYER.md](../API_MEMORY_AND_LEARNING_LAYER.md), [DATA_OWNERSHIP_AND_CONSUMPTION_MAP.md](../DATA_OWNERSHIP_AND_CONSUMPTION_MAP.md), [PERSONAL_INTELLIGENCE_LAYER.md](./PERSONAL_INTELLIGENCE_LAYER.md), [TODAY_PERSONALIZATION_CORE.md](../TODAY_PERSONALIZATION_CORE.md), [DAY_CONTEXT_V0.md](../DAY_CONTEXT_V0.md), [DAY_CONTEXT_V0.md](../DAY_CONTEXT_V0.md).
...
**PR gate:** три контура — Experience · Architecture · **Learning Δ** — [PIM_PR_GATE_V1.md](./PIM_PR_GATE_V1.md). **North star:** [TODAYFLOW_PRODUCT_CANON_UNIFIED.md §6](../TODAYFLOW_PRODUCT_CANON_UNIFIED.md#6-критерий-успеха-north-star).
...
| 2b | **Interpretation Layer** | Reference + Engine — [INTERPRETATION_LAYER_AND_REFERENCE.md](../explainability/INTERPRETATION_LAYER_AND_REFERENCE.md) | ✅ canon; ⬜ code |
...
**Канон продукта:** [TODAYFLOW_PRODUCT_MODEL.md](../archive/TODAYFLOW_PRODUCT_MODEL.md) §4.10 · [PROFILE_SCREEN_MASTER.md](../profile/PROFILE_SCREEN_MASTER.md) §7.
...
3. **Interpretation Layer** — [INTERPRETATION_LAYER_AND_REFERENCE.md](../explainability/INTERPRETATION_LAYER_AND_REFERENCE.md)  
