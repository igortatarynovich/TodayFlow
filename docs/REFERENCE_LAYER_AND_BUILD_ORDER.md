...
| Practice | PracticeTemplate | `CONTENT/practices/practices.json` (legacy) | class, type, duration, intensity, state_tags | title, steps, outcome | Flow, Today recommendations | partial — fill against taxonomy v1 |
