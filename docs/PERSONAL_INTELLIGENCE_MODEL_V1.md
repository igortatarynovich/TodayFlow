...
**Критерий успеха продукта:** [PIM_PRODUCT_NORTH_STAR.md](./PIM_PRODUCT_NORTH_STAR.md) — завершённый цикл → ценность PIM ↑.
...
**Intent Record = signals.** **Atom = promoted interpretation** с доказуемостью. См. [INTERPRETATION_LAYER_AND_REFERENCE.md](./INTERPRETATION_LAYER_AND_REFERENCE.md).
