...
**NOW (1.3.80):** Planet Canon storage locked. Next ≠ this dashboard. Next = write `canon` onto drafts. Do not score CORE from these KPIs. Do not rewrite objects from this file.
