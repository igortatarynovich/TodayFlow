...
**Next named (1.3.82):** smoke-test in ([PLANET_CANON_COMPOSITION_SMOKE_V1.md](./PLANET_CANON_COMPOSITION_SMOKE_V1.md)). Next = Signs Mainstream map for Sign Canon grammar. Not QUALITY. Not rewrite `function`. Not CORE.
