...
**Next named:** Mainstream Angle Semantic Map — **done 1.3.100.** Angle Canon grammar — **done 1.3.101** (one slot: `orientation`). Angle Canon fill — **done 1.3.102.** Angle Canon storage/materialization — **done 1.3.103.** Next = stored Planet×Angle smoke. Sequence (do not skip): stored Planet×Angle smoke → **STOP Angles** → final atomic smoke (Planet + Sign + House + Aspect + Angle, all stored) → Knowledge Core V1 FREEZE → IL-2. **STOP Aspects.** **STOP Houses.** **STOP Signs.** Do not start CORE scoring. Do not start ASC cookbooks.
