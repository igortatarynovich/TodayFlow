...
**Next named:** write `canon` onto the twelve sign drafts from [SIGN_CANON_V1.md](./SIGN_CANON_V1.md) — **done 1.3.87.** Planet × Sign smoke-test — **done 1.3.88.** Houses Mainstream map — **done 1.3.89.** House Canon grammar — **done 1.3.90.** Next = House Canon fill. STOP Signs.
