...
## 6. Execution order (LOCKED, then redirected 1.3.82)
...
11. Signs Mainstream map → Sign Canon grammar  NEXT  territory first; not QUALITY fill
12. Houses Mainstream map → House Canon grammar
13. IL-1 V1 close-out / IL-2 Composition
```
...
- **1.11 (2026-08-21)** — Composition smoke-test (1.3.82). Aspect PASS. Sign/house PARTIAL. Next = Signs Mainstream for Sign Canon grammar.
