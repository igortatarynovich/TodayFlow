...
## 6. Execution order (LOCKED, then redirected 1.3.83)
...
12. Sign Canon grammar                         NEXT  atoms PlanetInSign needs; not fill
13. Houses Mainstream map → House Canon grammar
14. IL-1 V1 close-out / IL-2 Composition
```
...
- **1.12 (2026-08-21)** — Mainstream Sign Semantic Map (1.3.83). Same panel as planets. Classification is not proof. Trait ≠ manner named, not split. Next = Sign Canon grammar.
