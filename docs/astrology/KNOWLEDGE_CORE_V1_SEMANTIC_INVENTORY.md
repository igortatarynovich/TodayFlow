...
## 6. Execution order (LOCKED, then redirected 1.3.86)
...
15. Write packs onto sign drafts → smoke       NEXT
16. Houses Mainstream map → House Canon grammar
17. IL-1 V1 close-out / IL-2 Composition
```
...
- **1.15 (2026-08-21)** — Sign Canon storage (1.3.86). Optional `canon` on signs. Next = write packs onto drafts.
