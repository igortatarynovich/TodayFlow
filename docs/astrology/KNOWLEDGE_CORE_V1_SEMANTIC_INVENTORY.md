...
## 6. Execution order (LOCKED, then redirected 1.3.89)
...
18. House Canon grammar                        NEXT
19. IL-1 V1 close-out / IL-2 Composition
```
...
- **1.18 (2026-08-22)** — Mainstream House Semantic Map (1.3.89). Same panel. House ≠ angle. Next = House Canon grammar.
