...
## 6. Execution order (LOCKED, then redirected 1.3.90)
...
19. House Canon fill                           NEXT
20. IL-1 V1 close-out / IL-2 Composition
```
...
- **1.19 (2026-08-22)** — House Canon grammar (1.3.90). One slot (`arena`). Next = House Canon fill.
