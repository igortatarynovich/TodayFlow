...
- **SoT after:** this inventory is the **owner-approved V1 freeze map**. New **books** remain forbidden unless a named `KC-*` row has a V1-required constituent that is actually missing. **1.3.76:** product meaning comes from Mainstream convention. **1.3.77:** planet map locked. **1.3.78:** Planet Canon grammar locked. **1.3.79:** Planet Canon V1 locked. **1.3.80:** `canon` storage locked. **1.3.81:** Sun–Saturn `canon` filled. **1.3.82:** smoke-test — aspect PASS, sign/house PARTIAL. **1.3.83:** Signs Mainstream map locked. **1.3.84:** Sign Canon grammar locked. **1.3.85:** Sign Canon fill locked. **1.3.86:** Sign Canon storage locked. **1.3.87:** Sign Canon materialization locked. **1.3.88:** Planet × Sign smoke-test PASS. **1.3.89:** Houses Mainstream map locked. **1.3.90:** House Canon grammar locked. **1.3.91:** House Canon fill locked. Next execution = House Canon storage/materialization. STOP Signs. Co–Star is a recognition check. Do not rewrite `function` this inventory.
...
## 6. Execution order (LOCKED, then redirected 1.3.91)
...
20. House Canon storage / materialization      NEXT
21. Planet × House smoke → STOP Houses / Aspects
```
...
- **1.20 (2026-08-22)** — House Canon fill (1.3.91). Twelve packs. Next = storage/materialization.
