...
**Next named:** Aspect Canon fill — **done 1.3.96.** Aspect Canon storage/materialization — **done 1.3.97.** Next = 1.3.98 stored Planet × Aspect smoke. Then stored Planet × Aspect smoke → **STOP Aspects** → ASC/MC → final atomic smoke → Knowledge Core V1 FREEZE. After freeze: IL-2. **STOP Houses.** **STOP Signs.** Do not reopen 1.3.94 research.

---

## Changelog

- **1.3 (2026-08-22)** — Aspect Canon storage/materialization locked 1.3.97. Grammar unchanged. Next = 1.3.98 stored Planet × Aspect smoke.
