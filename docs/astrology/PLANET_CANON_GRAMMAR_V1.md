...
**Next named (one task):** smoke-test **locked 1.3.82**. Sign map **locked 1.3.83**. Sign grammar **locked 1.3.84**. Sign Canon fill **locked 1.3.85**. Sign Canon storage **locked 1.3.86**. Sign Canon materialization **locked 1.3.87**. Next = 1.3.88 Planet × Sign smoke-test.
