...
**Next named:** House Canon storage / materialization (one pass). Then Planet × House stored smoke-test. **STOP Houses** after that PASS. Do not enrich packs for richness. Next semantic owner after house smoke = Aspect.
