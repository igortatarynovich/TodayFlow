...
**Next named:** Signs Mainstream Semantic Map — **done 1.3.83.** Next = Sign Canon Grammar (which atoms PlanetInSign needs). House Canon later. Do not fill signs from Lilly QUALITY.
...
**Next named:** Sign Canon Grammar V1 — which atoms PlanetInSign needs. Not fill.
...
Не начинать с 10 000 комбинаций. Методология отбора смысла: **1.3.76–1.3.82** Mainstream → grammar → packs → storage → fill → smoke-test. **1.3.83** Sign Mainstream map. Дальше Sign Canon grammar, не pair essays. Слои / provenance shape без нового enum.
...
- **1.3.83 (2026-08-21)** — IL-1 process (no ingest, no object change, no schema): Mainstream Sign Semantic Map. Same panel as planets. Include/secondary/exclude locked for 12 signs. Classification is not proof. Trait ≠ manner named, not split. Next = Sign Canon grammar, not fill, not houses.
