...
**Not this pass:** public JSON fields · set `active` · lemma rewrite · IL engine reopen · Relevance.
...
Масштаб библиотеки — **done 1.3.110.** Wire calc → IL — **done 1.3.111.** Attach IL-4 to surfaces — **done 1.3.112.** Если модель не выдерживает источники — чинить ontology, не плодить объекты и не трогать Today-прозу.
