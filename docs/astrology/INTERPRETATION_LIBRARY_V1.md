...
**Next named:** **1.3.82 composition smoke-test** — **done.** Aspect pairs PASS. Sign/house PARTIAL. Next = Signs Mainstream map as territory for Sign Canon grammar.
...
**Next named:** Signs Mainstream Semantic Map as territory for **Sign Canon grammar**. House Canon later. Do not fill signs from Lilly QUALITY.
...
Не начинать с 10 000 комбинаций. Методология отбора смысла: **1.3.76–1.3.82** Mainstream → grammar → packs → storage → fill → smoke-test. Дальше Sign Canon path, не pair essays. Слои / provenance shape без нового enum.
...
- **1.3.82 (2026-08-21)** — IL-1 diagnostic (no ingest, no object change, no schema): composition smoke-test. Mars□Saturn and Jupiter△Sun PASS. Venus×Capricorn and Moon×4th PARTIAL. Next = Signs Mainstream map for Sign Canon grammar, not QUALITY fill.
