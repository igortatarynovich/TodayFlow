...
**Next named:** Signs Mainstream Semantic Map — **done 1.3.83.** Sign Canon grammar — **done 1.3.84.** Sign Canon fill — **done 1.3.85.** Sign Canon storage — **done 1.3.86.** Next = write packs onto sign drafts. House Canon later. Do not fill signs from Lilly QUALITY.
...
**Next named:** Sign Canon Grammar V1 — **done 1.3.84.** Sign Canon fill — **done 1.3.85.** Sign Canon storage — **done 1.3.86.** Next = write packs onto sign drafts. Not houses.
...
**Next named:** Sign Canon fill — **done 1.3.85.** Sign Canon storage — **done 1.3.86.** Next = write packs onto sign drafts. Then repeat smoke-test.
...
**Next named:** Sign Canon storage — **done 1.3.86.** Next = write packs onto sign drafts. Then repeat smoke-test.
...
**Next named:** write `canon` onto the twelve sign drafts. Then repeat smoke-test. House Canon later.
...
Не начинать с 10 000 комбинаций. Методология отбора смысла: **1.3.76–1.3.82** Mainstream → grammar → packs → storage → fill → smoke-test. **1.3.83** Sign Mainstream map. **1.3.84** Sign Canon grammar. **1.3.85** Sign Canon fill. **1.3.86** Sign Canon storage. Дальше write packs onto sign drafts, не pair essays. Слои / provenance shape без нового enum.
...
- **1.3.86 (2026-08-21)** — IL-1 schema (no object fill, no CORE, catalog unchanged): Sign Canon storage. Optional `canon` nest on `type=sign` with `manner` · `excess`. Legacy later-interpretive `excess` not the product map. Next = write packs onto sign drafts.
