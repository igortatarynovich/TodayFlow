...
**Next named:** schema pass — **done 1.3.80.** Next = write `canon` onto Sun–Saturn drafts. Do not rewrite `function`.
...
**Next named:** write `canon` onto Sun–Saturn from [PLANET_CANON_V1.md](./PLANET_CANON_V1.md). Elemental `function` stays. Outers still withheld. Then Signs Mainstream map.
...
Не начинать с 10 000 комбинаций. Методология отбора смысла: **1.3.76–1.3.80** Mainstream → grammar → packs → `canon` storage. Дальше fill nest на объекты. Слои / provenance shape без нового enum.
...
- **1.3.80 (2026-08-21)** — IL-1 schema (no object fill, no CORE, catalog unchanged): Planet Canon storage. Optional `canon` nest with six grammar slots. Legacy keys not the product map. Next = write `canon` onto Sun–Saturn drafts.
