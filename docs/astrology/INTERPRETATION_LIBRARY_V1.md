...
**Next named:** **1.3.82 composition smoke-test** (Mars □ Saturn · Venus × Capricorn · Moon × 4th · Jupiter △ Sun). Not IL-2. If the six slots cannot compose without `themes` or pair essays, fix grammar/packs before Signs Mainstream map.
...
Не начинать с 10 000 комбинаций. Методология отбора смысла: **1.3.76–1.3.81** Mainstream → grammar → packs → storage → Sun–Saturn `canon`. Дальше 1.3.82 smoke-test, потом Signs. Слои / provenance shape без нового enum.
...
- **1.3.81 (2026-08-21)** — IL-1 catalog (no schema, no synthesis, no `function` rewrite): copy 1.3.79 packs onto Sun–Saturn `object.canon`. Outers withheld. Next = 1.3.82 composition smoke-test, not Signs.
