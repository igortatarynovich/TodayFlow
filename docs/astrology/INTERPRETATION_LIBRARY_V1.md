...
**Next named:** IL-2 composition rules (not pair catalog). **STOP Angles.** **STOP Aspects.** **STOP Houses.** **STOP Signs.** Layer 2 Signs stays classification-complete / interpretation-deferred. Do **not** start CORE scoring. Do **not** start ASC cookbooks.
...
| **IL-2** | Composition rules (не полный каталог пар) | next named after 1.3.106; may demote Layer 5 candidates to composed |
