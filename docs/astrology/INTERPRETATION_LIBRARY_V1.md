...
| Psychological later-interpretive | **IN as a cell:** one of Arroyo Part II ch.9–12 / Martin Vol. 1 structure lessons / Hamaker *Elements and Crosses*. **No winner.** TOC is not L2-C1. Score L2-C7+C8 when a body opens. |
...
**Stopped before Pulse Part One.** Cell C remains a cell. Next named extract = Rudhyar *Pulse of Life* Part One as **humanistic** later-interpretive, not as psychological, and not as a substitute for C.
