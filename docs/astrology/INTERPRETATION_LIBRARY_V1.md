...
- **SoT after:** IL-3 = sky-internal astrological theme rank only. User Relevance / Prioritization stay outside Astrology (pipeline I0 Personal overlay + later Meaning layer). Not a new SoT file; not a repo tree; not IL-3 implementation. Boundary: [IL1_HANDOFF.md](./IL1_HANDOFF.md) §3.
- **Public contract changed?** no
- **Migration required?** no
- **Canon updated?** yes — this Sequence table · §6.61 next named · handoff §3 · inventory step 36 · tracker NOW
...
**Next named:** IL-2 composition rules — **done 1.3.107.** Next = IL-3 engine. **STOP Angles.** **STOP Aspects.** **STOP Houses.** **STOP Signs.** Layer 2 Signs stays classification-complete / interpretation-deferred. Do **not** start CORE scoring. Do **not** start ASC cookbooks.
...
**Next named:** IL-3 Interpretation Engine (sky → astrological themes). **IL-3 rank ≠ user relevance rank** — handoff §3. **STOP Angles.** **STOP Aspects.** **STOP Houses.** **STOP Signs.** Do **not** start CORE scoring. Do **not** start ASC cookbooks. Do **not** start Relevance / Prioritization engines.
...
| **IL-3** | Interpretation Engine (sky → themes) | next named after 1.3.107 |
