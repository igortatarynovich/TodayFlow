...
**Next named:** Signs Mainstream Semantic Map — **done 1.3.83.** Sign Canon grammar — **done 1.3.84.** Next = Sign Canon fill. House Canon later. Do not fill signs from Lilly QUALITY.
...
**Next named:** Sign Canon Grammar V1 — **done 1.3.84.** Next = Sign Canon fill. Not houses.
...
**Next named:** Sign Canon fill (origin control, all 12). Then storage. Then repeat smoke-test.
...
Не начинать с 10 000 комбинаций. Методология отбора смысла: **1.3.76–1.3.82** Mainstream → grammar → packs → storage → fill → smoke-test. **1.3.83** Sign Mainstream map. **1.3.84** Sign Canon grammar. Дальше Sign Canon fill, не pair essays. Слои / provenance shape без нового enum.
...
- **1.3.84 (2026-08-21)** — IL-1 process (no ingest, no object change, no schema): Sign Canon grammar. Two slots (`manner` · `excess`). Sign = how, not person. Canon narrower than territory is expected. Next = Sign Canon fill, not houses.
