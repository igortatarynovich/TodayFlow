...
**Next named:** TodayFlow Planet Canon **shape** (generative slots for composition). Then fill. Not before.
...
Не начинать с 10 000 комбинаций. Методология отбора смысла: **1.3.76 Product Canon vs Lenses** · **1.3.77 Mainstream planet map**. Canon *shape* is next. Слои / provenance shape без нового enum.
...
- **1.3.77 (2026-08-21)** — IL-1 process (no ingest, no objects, no schema): Mainstream Planet Semantic Map. Panel = Astrodienst · Cafe Astrology · Astrology.com. Concept families, not 2/3 word vote. Territory + include/secondary/exclude locked. Not Canon. Next = Planet Canon shape.
