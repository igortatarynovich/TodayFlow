...
- **SoT after:** ten packs locked with direct / direct-secondary / derived. Four audits. Dry-run not auto-Canon. Next = schema pass.
- **Public contract changed?** no
- **Migration required?** no
...
**Next named:** **1.3.79** fill — **done.** Next = schema pass. No literature.
...
**Next named:** schema pass — map the six slots onto storage. Do not shrink grammar to old IL keys.
...
Не начинать с 10 000 комбинаций. Методология отбора смысла: **1.3.76–1.3.79** Mainstream → grammar → Planet Canon V1. Дальше schema. Слои / provenance shape без нового enum.
...
- **1.3.79 (2026-08-21)** — IL-1 process (no ingest, no objects, no schema): Planet Canon V1. Ten packs locked. Origin direct/derived. Four audits. Dry-run not auto-Canon. Next = schema pass.
