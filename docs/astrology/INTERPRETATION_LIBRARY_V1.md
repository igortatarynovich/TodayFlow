...
- **SoT after:** same panel as planets/signs/houses/aspects. ASC + MC territories + include/secondary/exclude. House 1/10 vocabulary is not proof. Angular prominence is not meaning. Planet-on-angle cookbooks are out. Catalog untouched. Next = Angle Canon grammar, not fill.
- **Public contract changed?** no
- **Migration required?** no
...
**Next named:** ASC/MC definition (parent 1–4) — **done 1.3.99.** Mainstream Angle Semantic Map — **done 1.3.100.** Next = Angle Canon grammar. **STOP Aspects.** **STOP Houses.** **STOP Signs.**
...
**Next named:** Mainstream Angle Semantic Map — **done 1.3.100.** Next = Angle Canon grammar. Sequence: grammar → fill → storage → stored Planet×Angle smoke → STOP Angles → final atomic smoke → FREEZE → IL-2. **STOP Aspects.** **STOP Houses.** **STOP Signs.**
...
Same panel as planets/signs/houses/aspects (Astrodienst · Cafe Astrology · Astrology.com). Concept families, not 2/3 word vote, not House 1/10 proof, not angular strength, not planet-conjunct-ASC/MC recipes. ASC = doorway-meeting / how-met / automatic-response / personal-facing. MC = culmination / public-facing / outer-mark / aiming-at-height. House-collision families stay secondary. Slot count undecided. Catalog unchanged.

**Not this pass:** Angle Canon slots · fill · objects · rising-sign portraits.

**Next named:** Angle Canon Grammar V1. Not fill. Then fill → storage/materialization → stored Planet×Angle smoke → STOP Angles → final atomic smoke → Knowledge Core V1 FREEZE. After freeze: IL-2. **STOP Aspects.** **STOP Houses.** **STOP Signs.**
...
Не начинать с 10 000 комбинаций. Методология отбора смысла: **1.3.76–1.3.82** Mainstream → grammar → packs → storage → fill → smoke-test. **1.3.83** Sign Mainstream map. **1.3.84** Sign Canon grammar. **1.3.85** Sign Canon fill. **1.3.86** Sign Canon storage. **1.3.87** Sign Canon materialization. **1.3.88** Planet × Sign smoke-test PASS. **1.3.89** Houses Mainstream map. **1.3.90** House Canon grammar. **1.3.91** House Canon fill. **1.3.92** House Canon storage/materialization. **1.3.93** Planet × House smoke-test PASS. **1.3.94** Mainstream Aspect Semantic Map. **1.3.95** Aspect Canon grammar. **1.3.96** Aspect Canon fill. **1.3.97** Aspect Canon storage/materialization. **1.3.98** stored Planet × Aspect smoke PASS. **1.3.99** Angle Canon model. **1.3.100** Mainstream Angle map. Дальше Angle Canon grammar, не pair essays. Слои / provenance shape без нового enum. STOP Aspects. STOP Houses. STOP Signs.
