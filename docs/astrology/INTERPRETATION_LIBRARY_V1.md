...
- **SoT after:** PlanetAtAngle frames read stored `canon.orientation`. Four gates PASS. Mars AT ASC ≠ Mars AT MC ≠ Mars IN 1st ≠ Mars IN 10th. Occupancy ≠ conjunction. Catalog unchanged. **STOP Angles.** Next = final atomic smoke.
- **Public contract changed?** no
- **Migration required?** no
...
**Next named:** Mainstream Angle Semantic Map — **done 1.3.100.** Angle Canon grammar — **done 1.3.101.** Angle Canon fill — **done 1.3.102.** Angle Canon storage/materialization — **done 1.3.103.** Stored Planet×Angle smoke — **done 1.3.104.** **STOP Angles.** Next = final atomic smoke → FREEZE → IL-2. **STOP Aspects.** **STOP Houses.** **STOP Signs.**
...
**Next named:** Angle Canon grammar — **done 1.3.101.** Angle Canon fill — **done 1.3.102.** Angle Canon storage/materialization — **done 1.3.103.** Stored Planet×Angle smoke — **done 1.3.104.** **STOP Angles.** Next = final atomic smoke → Knowledge Core V1 FREEZE. After freeze: IL-2. **STOP Aspects.** **STOP Houses.** **STOP Signs.**
...
**Next named:** Angle Canon fill — **done 1.3.102.** Angle Canon storage/materialization — **done 1.3.103.** Stored Planet×Angle smoke — **done 1.3.104.** **STOP Angles.** Next = final atomic smoke → Knowledge Core V1 FREEZE. After freeze: IL-2. **STOP Aspects.** **STOP Houses.** **STOP Signs.**
...
**Next named:** Angle Canon storage / materialization — **done 1.3.103.** Stored Planet×Angle smoke — **done 1.3.104.** **STOP Angles.** Next = final atomic smoke → Knowledge Core V1 FREEZE. After freeze: IL-2. **STOP Aspects.** **STOP Houses.** **STOP Signs.**
...
**Next named:** stored Planet×Angle composition smoke — **done 1.3.104.** **STOP Angles.** Next = final atomic smoke → Knowledge Core V1 FREEZE. After freeze: IL-2. **STOP Aspects.** **STOP Houses.** **STOP Signs.**
...
**Next named:** final atomic smoke (Planet + Sign + House + Aspect + Angle, all stored) → Knowledge Core V1 FREEZE. After freeze: IL-2. **STOP Angles.** **STOP Aspects.** **STOP Houses.** **STOP Signs.**
...
Не начинать с 10 000 комбинаций. Методология отбора смысла: **1.3.76–1.3.82** Mainstream → grammar → packs → storage → fill → smoke-test. **1.3.83** Sign Mainstream map. **1.3.84** Sign Canon grammar. **1.3.85** Sign Canon fill. **1.3.86** Sign Canon storage. **1.3.87** Sign Canon materialization. **1.3.88** Planet × Sign smoke-test PASS. **1.3.89** Houses Mainstream map. **1.3.90** House Canon grammar. **1.3.91** House Canon fill. **1.3.92** House Canon storage/materialization. **1.3.93** Planet × House smoke-test PASS. **1.3.94** Mainstream Aspect Semantic Map. **1.3.95** Aspect Canon grammar. **1.3.96** Aspect Canon fill. **1.3.97** Aspect Canon storage/materialization. **1.3.98** stored Planet × Aspect smoke PASS. **1.3.99** Angle Canon model. **1.3.100** Mainstream Angle map. **1.3.101** Angle Canon grammar (`orientation`). **1.3.102** Angle Canon fill. **1.3.103** Angle Canon storage/materialization. **1.3.104** stored Planet×Angle smoke PASS. Дальше final atomic smoke, не pair essays. Слои / provenance shape без нового evidence enum. STOP Angles. STOP Aspects. STOP Houses. STOP Signs.
...
- **1.3.104 (2026-08-23)** — IL-1 diagnostic (no ingest, no object change, no schema): stored Planet × Angle composition smoke. Four gates PASS from `canon.orientation`. Mars AT ASC ≠ Mars AT MC ≠ House 1/10. Occupancy ≠ conjunction. STOP Angles. Next = final atomic smoke. STOP Aspects. STOP Houses. STOP Signs.
