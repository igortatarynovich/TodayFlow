...
- **SoT after:** `$defs.angle_canon_pack` (`orientation`). Two `type=angle` drafts carry locked 1.3.102 packs verbatim. Catalog 38 draft / 0 `active`. House 1/10 packs unchanged. Combos still omit `canon`. Runtime still ignores `draft`. Next = stored Planet×Angle smoke, not lemma rewrite.
...
**Next named:** Mainstream Angle Semantic Map — **done 1.3.100.** Angle Canon grammar — **done 1.3.101.** Angle Canon fill — **done 1.3.102.** Next = storage/materialization. Sequence: storage → stored Planet×Angle smoke → STOP Angles → final atomic smoke → FREEZE → IL-2. **STOP Aspects.** **STOP Houses.** **STOP Signs.**
...
**Next named:** Angle Canon grammar — **done 1.3.101.** Angle Canon fill — **done 1.3.102.** Next = storage/materialization. Then stored Planet×Angle smoke → STOP Angles → final atomic smoke → Knowledge Core V1 FREEZE. After freeze: IL-2. **STOP Aspects.** **STOP Houses.** **STOP Signs.**
...
**Next named:** Angle Canon fill — **done 1.3.102.** Angle Canon storage/materialization — **done 1.3.103.** Next = stored Planet×Angle smoke → STOP Angles → final atomic smoke → Knowledge Core V1 FREEZE. After freeze: IL-2. **STOP Aspects.** **STOP Houses.** **STOP Signs.**
...
**Next named:** Angle Canon storage / materialization — **done 1.3.103.** Next = stored Planet×Angle smoke → STOP Angles → final atomic smoke → Knowledge Core V1 FREEZE. After freeze: IL-2. **STOP Aspects.** **STOP Houses.** **STOP Signs.**
...
**Next named:** stored Planet×Angle composition smoke. Then STOP Angles → final atomic smoke → Knowledge Core V1 FREEZE. After freeze: IL-2. **STOP Aspects.** **STOP Houses.** **STOP Signs.**
...
Не начинать с 10 000 комбинаций. Методология отбора смысла: **1.3.76–1.3.82** Mainstream → grammar → packs → storage → fill → smoke-test. **1.3.83** Sign Mainstream map. **1.3.84** Sign Canon grammar. **1.3.85** Sign Canon fill. **1.3.86** Sign Canon storage. **1.3.87** Sign Canon materialization. **1.3.88** Planet × Sign smoke-test PASS. **1.3.89** Houses Mainstream map. **1.3.90** House Canon grammar. **1.3.91** House Canon fill. **1.3.92** House Canon storage/materialization. **1.3.93** Planet × House smoke-test PASS. **1.3.94** Mainstream Aspect Semantic Map. **1.3.95** Aspect Canon grammar. **1.3.96** Aspect Canon fill. **1.3.97** Aspect Canon storage/materialization. **1.3.98** stored Planet × Aspect smoke PASS. **1.3.99** Angle Canon model. **1.3.100** Mainstream Angle map. **1.3.101** Angle Canon grammar (`orientation`). **1.3.102** Angle Canon fill. **1.3.103** Angle Canon storage/materialization. Дальше stored Planet×Angle smoke, не pair essays. Слои / provenance shape без нового evidence enum. STOP Aspects. STOP Houses. STOP Signs.
...
- **1.3.103 (2026-08-22)** — IL-1 schema + catalog: Angle Canon storage/materialization. Optional `canon` nest on `type=angle` (`orientation`). Two drafts carry locked 1.3.102 packs. House 1/10 unchanged. Next = stored Planet×Angle smoke. STOP Aspects. STOP Houses. STOP Signs.
