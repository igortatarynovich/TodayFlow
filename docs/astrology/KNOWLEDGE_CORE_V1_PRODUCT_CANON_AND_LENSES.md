...
**Next named (one task):** smoke-test locked (1.3.82). Sign map locked (1.3.83). Sign grammar locked (1.3.84). Sign Canon fill locked (1.3.85). Sign Canon storage locked (1.3.86). Sign Canon materialization locked (1.3.87). Planet × Sign smoke-test locked (1.3.88). Houses Mainstream map locked (1.3.89). House Canon grammar locked (1.3.90). Next = House Canon fill. STOP Signs. Do not rewrite `function`.

---

## Changelog

- **1.11 (2026-08-22)** — 1.3.90 House Canon grammar. One slot (`arena`). planet.domains ≠ house.arena. Next = fill, not objects.
