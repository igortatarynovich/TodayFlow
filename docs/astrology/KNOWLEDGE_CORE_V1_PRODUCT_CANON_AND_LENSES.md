...
**Next named (one task):** smoke-test locked (1.3.82). Sign map locked (1.3.83). Sign grammar locked (1.3.84). Next = Sign Canon fill. Do not rewrite `function`.

---

## Changelog

- **1.5 (2026-08-21)** — 1.3.84 Sign Canon grammar. Two slots. Sign = how. Next = fill, not houses.
