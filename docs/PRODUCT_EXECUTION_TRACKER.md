...
**NOW (PRACTICES / CANON, 2026-08-30):** **P0 type coverage** — all 26 P0 need cells sourced; now filling P0 spine types. Latest: `meditation.breath_awareness` accepted (NHS Mindfulness + Guy's and St Thomas' NHS MBSR exercises): sit, bring attention to natural sensations of breathing without controlling it, return when mind wanders. `meditation.breath_awareness.001/002/003` active with `technique_id`. P0 spine type coverage: 31/44 sourced. `box_breathing`, `energizing_breath`, `abstinence`, and `self_trust` remain skipped. Next non-skipped P0 spine type: `meditation.body_scan`. [PRACTICE_LIBRARY_FILL_V1](./practices/PRACTICE_LIBRARY_FILL_V1.md). Meaning still does not emit `item_id` or `technique_id`.
