...
**NOW (PRACTICES / CANON, 2026-08-30):** **P0 type coverage** — all 26 P0 need cells sourced; now filling P0 spine types. Latest: `meditation.grounding` accepted (NHS inform + Royal Berkshire NHS): sit and bring attention to physical contact points (weight on seat, feet on floor, back against chair), noticing contact and support for a few breaths without trying to change state. `meditation.grounding.001/002/003` active with `technique_id`. P0 spine type coverage: 34/44 sourced. `box_breathing`, `energizing_breath`, `abstinence`, and `self_trust` remain skipped. Next non-skipped P0 spine type: `meditation.letting_go`. [PRACTICE_LIBRARY_FILL_V1](./practices/PRACTICE_LIBRARY_FILL_V1.md). Meaning still does not emit `item_id` or `technique_id`.
