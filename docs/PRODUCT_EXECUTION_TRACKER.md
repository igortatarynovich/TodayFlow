...
- 2026-07-25 | Today / Scenario | **Day Scenario SoT + product capture** | **IN_PROGRESS** | Canon [DAY_SCENARIO_V1.md](./DAY_SCENARIO_V1.md) · **B1–B5 + C1 landed** (native scenario LLM on refresh; legacy expect/trap schema out of runtime SoT) · [C1 note](./audits/DAY_SCENARIO_NATIVE_LLM_C1.md) · **next:** C2 Chapters UI
