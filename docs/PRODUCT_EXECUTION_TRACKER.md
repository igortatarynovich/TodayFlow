...
> **Активный фокус (2026-07-25):** **Character Engine schema v0.2** — JSON Schema + ID stability landed ([CHARACTER_ENGINE_SCHEMA_CONTRACTS_V0](audits/CHARACTER_ENGINE_SCHEMA_CONTRACTS_V0.md)). **Next:** Stage 0–1 fact/evidence builders → pipeline behind flag. CI job for schema needs workflow-scoped push. Не UI redesign; не dual publish.
...
- 2026-07-25 | Today / Scenario | **Day Scenario SoT + product capture** | **IN_PROGRESS** | Canon [DAY_SCENARIO_V1.md](./DAY_SCENARIO_V1.md) · **B1–B4 landed** (engine + props + wire + FE preference for chorus/talisman/scenes) · capture packs · **next:** fuller scene UI / runtime_sot switch with Architecture impact · [B4 note](./audits/DAY_SCENARIO_UI_PREFERENCE_B4.md)
