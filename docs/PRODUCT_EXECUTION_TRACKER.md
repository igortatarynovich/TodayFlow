...
- 2026-07-22 | Docs | **Docs governance PR-1** | **DONE** | Root [AGENTS.md](../AGENTS.md) · restored/tracked [docs-single-canon.mdc](../.cursor/rules/docs-single-canon.mdc) (`.gitignore` now keeps `.cursor/rules/**`; root cause of prior 404) · [docs/README.md](./README.md) = five-section entry (interim authorities until Product Surface Map) · soft gate for new MAP/REGISTRY/PASSPORT/CANON · [DOCUMENTATION_INVENTORY.md](./DOCUMENTATION_INVENTORY.md) before archive. **Next:** PR-2 Product Surface Map.
