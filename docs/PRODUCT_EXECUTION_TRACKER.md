...
**NOW (PRACTICES / CANON, 2026-08-30):** **P0 type coverage** — all 26 P0 need cells sourced; now filling P0 spine types. Latest: `affirmation.relationship` accepted (Stinson et al. 2011 + Cohen & Sherman 2014): state a first-person statement that one can take one warm step toward another person (e.g., 'I can take one warm step toward a person'), spoken once or twice. `affirmation.relationship.001/002/003` active with `technique_id`. P0 spine type coverage: 38/44 sourced. `box_breathing`, `energizing_breath`, `abstinence`, and `self_trust` remain skipped. Next non-skipped P0 spine type: `discipline.digital_limit`. [PRACTICE_LIBRARY_FILL_V1](./practices/PRACTICE_LIBRARY_FILL_V1.md). Meaning still does not emit `item_id` or `technique_id`.
