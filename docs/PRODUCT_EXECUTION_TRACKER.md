...
- 2026-07-26 | Profile / Architecture | **CE Stage 3 Internal Engine** | **IN_PROGRESS / SHADOW** | Prompt `stage3.v1` **1.0.0** · expand-only · consumption v0.5 prefers Stage 3 trap/decision · [CHARACTER_ENGINE_STAGE3_INTERNAL_V0.md](audits/CHARACTER_ENGINE_STAGE3_INTERNAL_V0.md). Owner override of prior HOLD. **Next:** live voice skim · then Stage 4. `PUBLISH_READY=0`.
- 2026-07-26 | Profile / Architecture | **CE → Profile consumption slice v0** | **LIVE v0.5** | + Stage 3 trap/decision when grounded · matrix/aspect from v0.4 · Swiss natal facts kept · [CHARACTER_ENGINE_PROFILE_CONSUMPTION_V0.md](audits/CHARACTER_ENGINE_PROFILE_CONSUMPTION_V0.md).
