...
**NOW (P1 REVIEW, 2026-08-31):** P1 type `practice.review` sourced via `technique.review` (NHS Transformation Partners End of Shift Wellbeing Checklist + UH Bristol reflective writing + NHS Borders look back): look back at today or one event; name one hard thing and one thing that went okay or helped, then stop. Distinct from journaling, prompted_reflection, gratitude, self_check_in, and evening_ritual. Not Gibbs/AAR. `practice.review.001` active. Coverage 142 items, 9/42 P1 sourced. Next: `practice.visualization`.
