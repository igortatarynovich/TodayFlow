...
- 2026-07-27 | Today / Product | **Today Depth Layer step 1 (gate)** | **DONE** | `today_depth_layer_v1` · topics + `intimacy` · Free deepen → CTA · Trial/Paid generate · [TODAY_DEPTH_LAYER_V1.md](./TODAY_DEPTH_LAYER_V1.md) · **next:** FE picker
