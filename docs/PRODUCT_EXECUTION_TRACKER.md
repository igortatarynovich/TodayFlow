...
**NOW (PRACTICES / CANON, 2026-08-30):** **P0 type coverage** — all 26 P0 need cells sourced; now filling P0 spine types. Latest: `meditation.open_awareness` accepted (Lutz et al. 2008 + Mindful.net): sit, lightly notice or name whatever is present in one word, without explaining or judging, return to open awareness. `meditation.open_awareness.001/002/003` active with `technique_id`. P0 spine type coverage: 33/44 sourced. `box_breathing`, `energizing_breath`, `abstinence`, and `self_trust` remain skipped. Next non-skipped P0 spine type: `meditation.grounding`. [PRACTICE_LIBRARY_FILL_V1](./practices/PRACTICE_LIBRARY_FILL_V1.md). Meaning still does not emit `item_id` or `technique_id`.
