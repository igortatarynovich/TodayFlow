...
- 2026-07-25 | Today / Scenario | **Day Scenario SoT + product capture** | **IN_PROGRESS** | Canon [DAY_SCENARIO_V1.md](./DAY_SCENARIO_V1.md) · **B1–B5 + C1–C3.2 + C3.3a landed** (personalization evidence contract) · [C3.3a note](./audits/DAY_SCENARIO_PERSONALIZATION_C33A.md) · **next:** C3.3b sphere selection / pairwise eval · C3.5 eval pack
