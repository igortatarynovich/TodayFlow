...
- 2026-07-26 | Profile / Architecture | **CE Stage 2 live shadow** | **ON / REVIEWED** | `STAGE2_SHADOW=1` · [CHARACTER_ENGINE_STAGE2_LIVE_REVIEW_V0.md](audits/CHARACTER_ENGINE_STAGE2_LIVE_REVIEW_V0.md). Aquarius + Pisces grounded (RU loglines) · empty → insufficient · Stage 2 LLM only on publish/refresh · thesis map covers presence/freedom. **Next:** voice review · no Stage 3 / no `PUBLISH_READY`.
...
- 2026-07-26 | Today / Scenario | **Day Scenario SoT + product capture** | **IN_PROGRESS** | Canon [DAY_SCENARIO_V1.md](./DAY_SCENARIO_V1.md) · **B1–B5 + C1–C3.6.1 landed** · [C3.6.1 calibration](./audits/DAY_SCENARIO_GATE_CALIBRATION_C361.md) (synthetic_bootstrap · TP/FP/TN/FN · measured\|insufficient · no promotions) · [baseline](./audits/DAY_SCENARIO_GATE_CALIBRATION_BASELINE_C361.md) · **next:** **C3.6.2 Human Golden Set and Review Protocol** → live shadow → promote by evidence
