...
- 2026-07-21 | Profile | Profile E2E architecture principle | **ACTIVE** | No «модель выдумала»; only architectural defect classes; block passport required; patterns = gate not prompt. [PROFILE_E2E_RECONSTRUCTION.md](./PROFILE_E2E_RECONSTRUCTION.md) · [PROFILE_E2E_BLOCK_PASSPORT_TEMPLATE.md](./audits/PROFILE_E2E_BLOCK_PASSPORT_TEMPLATE.md)
