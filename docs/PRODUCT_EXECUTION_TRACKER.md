...
- 2026-07-25 | Today / Scenario | **Day Scenario SoT + product capture** | **IN_PROGRESS** | Canon [DAY_SCENARIO_V1.md](./DAY_SCENARIO_V1.md) · **B1–B5 + C1–C3.5 landed** (eval pack 14d × profiles × locales) · [C3.5 note](./audits/DAY_SCENARIO_EVAL_PACK_C35.md) · **next:** capture review with eval harness (live weeks → defect hotspots → then polish)
