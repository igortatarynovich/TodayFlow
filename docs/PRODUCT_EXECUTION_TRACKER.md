...
**IN PROGRESS (2026-07-30):** Wave 2 Phase D.2 trust audit **DONE (code)** · D.3 next. Practices **P1 session cycle**. ScreenFlow axis **LOCKED x**. Guest Story Surface P0 + Continuity slice 2 — **DONE**.
...
- 2026-07-30 | Today / Content | **Wave 2 Phase D.2 — Act 3 trust audit** | **DONE (code)** | Same `narrative_drivers_in_pool` on day_story wire → `ready=false` when conflict drivers miss natal pool; FE chapters already respect ready. [CONTRACT §7](./today/TODAY_WAVE2_CONTRACT_V1.md) · [PLAN D.2](./today/TODAY_WAVE2_EXECUTION_PLAN.md).
- 2026-07-30 | Today / Content | **Wave 2 Phase D.1b — narrative on day_facts** | **LIVE** | Project cached `day_scenario` onto `GET /today/day-facts` when temporal gate passes (natal ids ⊆ pool; event-pack ids need live non-empty natal pool); else `partial: true` (no invent). Body-label aliases fix empty activations. thesis=`label_ru`|null; evening_payoff null. Act3 still day_scenario nest; not-ready → Day Map/legacy. [CONTRACT](./today/TODAY_WAVE2_CONTRACT_V1.md) · [PLAN D.1b](./today/TODAY_WAVE2_EXECUTION_PLAN.md).
...
- 2026-07-30 | Profile / Content | **Act 3 form align vs draft** | **IN BRANCH** | Vertical cascade (not grounded‖help) · living honesty note · hide Character warehouse triad when insight node present · copy labels → Forms («На что опирается» / «Что помогает») · content prose vs samples still scenarist · [PROFILE_ACT3_NODE_DRAFT_V0.md](profile/PROFILE_ACT3_NODE_DRAFT_V0.md)
- 2026-07-29 | Profile / Content | **Acts 3–5 scenario backlog** | **OPEN** | Act3 form wired · Act3 prose QA + Act4 vector · Act5 bridge scenarist text still before Visual Modes (#4)
...
- 2026-07-26 | Today / Lifecycle | **Day Lifecycle V1 (assemble once)** | **DONE** | Clock **05:00–07:00 / 08:30** · GET never assembles · calm open from cache · pre-warm: celestial+fusion+symbol prebake · catch-up after ready · candidates push/schedule/recent · canon [DAY_LIFECYCLE_V1.md](./audits/DAY_LIFECYCLE_V1.md)
