...
- 2026-07-25 | Today / Scenario | **Day Scenario SoT + product capture** | **IN_PROGRESS** | Canon [DAY_SCENARIO_V1.md](./DAY_SCENARIO_V1.md) · **B1–B5 landed** (exclusive runtime meaning SoT; projector overwrites legacy slots; unavailable strips editorial) · [B5 note](./audits/DAY_SCENARIO_RUNTIME_SOT_B5.md) · **next:** fuller scene UI · optional LLM scenario-native prompt
