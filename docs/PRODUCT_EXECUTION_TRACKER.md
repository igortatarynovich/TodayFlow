...
**NOW (P1 MUSIC, 2026-09-17):** P1 type `practice.music` sourced via `technique.music` (NHS Every Mind Matters low mood + sleep tips + Mind Relaxation Listen to music): pick one short known track, play once, listen only to that, stop. Distinct from drawing, creative_prompt, and session accompaniment. Not music therapy, playlist programme, or sleep protocol. `practice.music.001` active. Coverage 147 items, 14/42 P1 sourced. Next: `practice.release_ritual`.
