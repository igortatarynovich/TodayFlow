...
**NOW (PRACTICES / CANON, 2026-08-30):** **P0 type coverage** — all 26 P0 need cells sourced; now filling P0 spine types. Latest: `meditation.reflection_meditation` accepted (NHS Scotland MBSR + Mindful.net): sit, ask one open question about present experience (e.g., 'What is my experience right now?'), do not answer immediately, stay with it for three breaths, then note one word. `meditation.reflection_meditation.001/002/003` active with `technique_id`. P0 spine type coverage: 36/44 sourced. `box_breathing`, `energizing_breath`, `abstinence`, and `self_trust` remain skipped. Next non-skipped P0 spine type: `affirmation.agency`. [PRACTICE_LIBRARY_FILL_V1](./practices/PRACTICE_LIBRARY_FILL_V1.md). Meaning still does not emit `item_id` or `technique_id`.
