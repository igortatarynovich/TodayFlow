...
**NOW (P1 DRAWING, 2026-09-17):** P1 type `practice.drawing` sourced via `technique.drawing` (CUH NHS Sketch Appeal + Calderdale and Kirklees Recovery College mindful drawing + Greater Good in Education Drawing as a Way to Manage Emotions): pen and paper, about two minutes freehand on something ordinary or simple shapes, stop. Distinct from creative_prompt, free_writing, and music. Not art class, Zentangle curriculum, or art therapy. `practice.drawing.001` active. Coverage 146 items, 13/42 P1 sourced. Next: `practice.music`.
