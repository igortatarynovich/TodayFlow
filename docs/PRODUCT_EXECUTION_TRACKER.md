...
- **Profile UI:** [PROFILE_SCREEN_MASTER.md](./PROFILE_SCREEN_MASTER.md) · [TODAYFLOW_FOUNDATION_UI.md](./TODAYFLOW_FOUNDATION_UI.md).
...
- 2026-07-21 | Eng / Audit | **P1 Experience wiring** | **IN_PROGRESS** | Doc [PERSONAL_MODEL_EXPERIENCE_WIRING_P1_2026-07-21.md](./audits/PERSONAL_MODEL_EXPERIENCE_WIRING_P1_2026-07-21.md) · risk confirmed: many assemblers · Tarot ignores core_profile in synthesis · CUM unused by Experiences · **next:** `experience_contract_assembler_v0` + allowlists · then C3 · P2 rename `build`→`get_or_baseline`/`publish_snapshot`
...
- 2026-07-21 | Product / Metric | **Reference Rate (hardened)** | **RESERVED** | Not «snapshot available» — generation used prior knowledge **impossible from current input alone** · [PROFILE_CONTENT_CANON §7.2](./PROFILE_CONTENT_CANON_V1.md) · ship with telemetry
- 2026-07-21 | Product / Roadmap | **Longitudinal Validation** | **RESERVED (after C3, not C4)** | Does the model change when facts accumulate? Snapshot shift from evidence, not LLM rewrite · Voice Consistency across time · [PROFILE_CONTENT_CANON §7.3](./PROFILE_CONTENT_CANON_V1.md)
