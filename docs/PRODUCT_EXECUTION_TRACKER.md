...
- 2026-08-01 | Profile / UI | **Visual Modes #4 — Act 3 spine** | **IN BRANCH** | Act 3 `insight-spine`: vertical rail + step dots, no nested proof-card stack · ≠ Act1 hero · ≠ Act2 grid · [PROFILE_VISUAL_MODES_V0.md](profile/PROFILE_VISUAL_MODES_V0.md) · Acts 4–5 décor polish still OPEN
