...
- 2026-07-30 | Profile / UI | **Why formation full-width 2-col** | **IN BRANCH** | Step 2 cards: drop desktop 4-col (left-clustered skinny cells) · 1 col mobile / 2 col desktop stretch scene width — same pattern as Effort spheres
- 2026-07-30 | Profile / UI | **Natal planet seal icons** | **IN BRANCH** | Heavier mask-optimized SVGs (`planets/*.svg` stroke 2.75 + filled cores) · inline/`PLANET_STROKE` parity · slightly larger disc glyph · iOS stroke weight · 3D still deferred until after live icon QA
