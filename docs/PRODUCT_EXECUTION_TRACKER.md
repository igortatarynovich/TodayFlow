...
- 2026-07-30 | Profile / Content | **Act 4–5 form: swipe spheres + bridge** | **IN BRANCH** | Effort: horizontal snap cards + tap expand (not encyclopedia grid) · title «Куда прикладывать усилия» · Bridge CTA «Открыть Today» · [PROFILE_ACT4_EFFORT_DRAFT_V0.md](profile/PROFILE_ACT4_EFFORT_DRAFT_V0.md) · [PROFILE_ACT5_BRIDGE_DRAFT_V0.md](profile/PROFILE_ACT5_BRIDGE_DRAFT_V0.md)
...
- 2026-07-29 | Profile / Content | **Acts 3–5 scenario backlog** | **OPEN** | Act3–5 **form** wired · remaining = scenarist prose QA · then Visual Modes (#4)
