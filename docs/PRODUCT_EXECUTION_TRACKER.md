...
- 2026-07-21 | Web product UI | PR-3 Today Production Surface | **PLANNED** | Вход: [PR3_TODAY_PRODUCTION_SURFACE.md](./PR3_TODAY_PRODUCTION_SURFACE.md). Сначала day_story_v1 audit (evidence/confidence/limitations/claim map/trace); затем блок-контракт Today; затем surface. Не Figma-first. App Shell = PR-2 CLOSED.
