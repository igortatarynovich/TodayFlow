...
- 2026-07-25 | Today / Scenario | **Day Scenario SoT + product capture** | **IN_PROGRESS** | Canon [DAY_SCENARIO_V1.md](./DAY_SCENARIO_V1.md) · **B1 engine landed** (`day_scenario_v1.py`: foundation/chorus/conflict/scenes, `runtime_sot=false`) · capture packs · **next:** B2 props-from-scenes (color/goals/affirm) · B3 wire projection · Architecture impact on switch
