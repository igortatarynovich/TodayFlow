...
**NOW (PRACTICES / CANON, 2026-08-30):** **P0 type coverage** — all 26 P0 need cells sourced; now filling P0 spine types. Latest: `practice.morning_ritual` accepted (NHS Every Mind Matters + Sonnentag & Kühnel 2016): after waking, do one or two simple physical actions (water/light/movement), name one task/day direction, and begin. `practice.morning_ritual.001/002/003` active with `technique_id`. P0 spine type coverage: 29/44 sourced. `box_breathing`, `energizing_breath`, `abstinence`, and `self_trust` remain skipped. Next non-skipped P0 spine type: `practice.evening_ritual`. [PRACTICE_LIBRARY_FILL_V1](./practices/PRACTICE_LIBRARY_FILL_V1.md). Meaning still does not emit `item_id` or `technique_id`.
