...
**NOW (P1 GRATITUDE, 2026-08-31):** P1 type `practice.gratitude` sourced via `technique.practice_gratitude` (NHS 10 stress busters + Every Mind Matters stress + Greater Good Three Good Things): write three specific things from today, then stop. Distinct from journaling, prompted_reflection, and meditation.gratitude. `practice.gratitude.001` active. Coverage 141 items, 8/42 P1 sourced. Next: `practice.review`.
