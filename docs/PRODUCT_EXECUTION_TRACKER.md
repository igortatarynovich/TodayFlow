...
- 2026-07-25 | Today / Architecture | **day_thesis + evidence pack in DayContext** | **IN_PROGRESS** | Evidence + FE parity shipped · **PR-5 slice:** editorial formula bank (A–C) + golden fixtures in day_story fallback · TL-1 still blocked · next: expand formula coverage / TL-0C.3 marking · linked: [TODAY_LANGUAGE_STRONG_PATTERNS_V0.md](./today-language/TODAY_LANGUAGE_STRONG_PATTERNS_V0.md)
