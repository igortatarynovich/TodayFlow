...
- 2026-07-21 | Today / Story | PR-3 day_story_v1 explainable slice | **IN PROGRESS** | Backend trace+gates done; FE `isDomainLensPresent` hides absent domains. Next: Composition Surface polish. [PR3_TODAY_PRODUCTION_SURFACE.md](./PR3_TODAY_PRODUCTION_SURFACE.md)
- 2026-07-21 | Web product UI | PR-3 Today Production Surface | **IN PROGRESS** | Path: App Shell → `TodayWebDashboard` composition → `TodayCompositionSurface`. Domain honesty landed; soft “почему” deferred.
