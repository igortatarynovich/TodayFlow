...
**NOW (P1 BOUNDARY ACTION, 2026-09-17):** P1 type `practice.boundary_action` sourced via `technique.boundary_action` (NHS Every Mind Matters work-related stress + Mind Practise saying no + Leicestershire Partnership NHS Assertiveness): pick one request you do not have room for, decline in one short line, stop. Distinct from micro_action, connection_action, digital_pause, and digital_limit. Not assertiveness curriculum, broken-record, rights lists, or treatment. `practice.boundary_action.001` active. Coverage 145 items, 12/42 P1 sourced. Next: `practice.drawing`.
