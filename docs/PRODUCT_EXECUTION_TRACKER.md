...
**IN PROGRESS (2026-07-30):** Wave 2 Phase D.2 day-facts `pt-*` gate **LIVE** · generation SoT **BACKLOG** · D.3 next. Practices **P1 session cycle**. ScreenFlow axis **LOCKED x**. Guest Story Surface P0 + Continuity slice 2 — **DONE**.
...
- 2026-07-30 | Today / Content | **Wave 2 — conflict.driver_ids generation SoT** | **BACKLOG** | Ranked pack ids (`sky-`/`phase-`/`moon-`) still feed conflict; D.2 gate omits day_facts narrative until generation writes natal `pt-*` ⊆ pool. Separate ticket — do not smuggle into slot/gate PRs. [PLAN D.2b](./today/TODAY_WAVE2_EXECUTION_PLAN.md).
