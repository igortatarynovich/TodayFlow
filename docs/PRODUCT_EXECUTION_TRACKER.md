...
- 2026-07-27 | Today / Product | **Today Depth Layer step 3 (FE picker)** | **DONE** | `TodayDepthLayerSection` · chips from `contract.depth_layer` · Free CTA / Paid generate · **next:** polish copy + optional intimacy prompt QA
