...
**IN PROGRESS (2026-08-04):** DS Task 1 — style gate (`scripts/check_ds_style_gate.py` + baseline 628 keys / CI job / PR checklist). Existing module.css debt = warning via baseline; new hex/ad-hoc/legacy-token-def = fail.  
