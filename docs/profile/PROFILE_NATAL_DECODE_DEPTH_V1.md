...
**Code:** `natal_decode_depth_v0.py` · `POST /account/profile/natal-decode` · IL-4 bind: [PROFILE_MEANING_POLISH_V1.md](./PROFILE_MEANING_POLISH_V1.md) (1.3.123) · cache refresh: [PROFILE_NATAL_DECODE_CACHE_REFRESH_V1.md](./PROFILE_NATAL_DECODE_CACHE_REFRESH_V1.md) (1.3.124)
