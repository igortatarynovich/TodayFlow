...
const SECTION_CONFIG = [
  {
    ...
    descriptionKey: "catalog.free.section.today",
    productIds: ["daily_personal", "premium_daily", "sky_events", "weekly_insight"]
  },
  {
    key: "personality",
    titleKey: "catalog.free.section.personality.title",
    descriptionKey: "catalog.free.section.personality",
    productIds: ["lite_birth_chart", "full_report", "psychology_report", "star_stories"]
  },
  {
    key: "love",
    titleKey: "catalog.nav.relationships.love",
    descriptionKey: "catalog.free.section.love",
    productIds: ["compatibility_portal", "tarot_relationship", "astroclick_partners"]
  },
  {
    key: "kids",
    titleKey: "catalog.free.section.kids.title",
    descriptionKey: "catalog.free.section.kids",
    productIds: ["child_profile", "parenting_checkin"]
  },
  {
    key: "traditional",
    titleKey: "catalog.free.section.traditional.title",
    descriptionKey: "catalog.free.section.traditional",
    productIds: ["best_moment", "eclipse_report"]
  },
  {
    key: "visual",
    titleKey: "catalog.free.section.visual.title",
    descriptionKey: "catalog.free.section.visual",
    productIds: ["birth_chart_visual", "planet_tracker", "ephemerides_builder", "atlas_lookup"]
  }
];
        ...
        <div className="orbit-hero-design-wrapper">
          ...
          <div className="orbit-hero-design-container">
            <p className="orbit-hero-design-subtitle" style={{ textAlign: "center", marginBottom: "var(--orbit-space-sm)", color: "rgba(255, 255, 255, 0.85)" }}>
              {t("catalog.free.hero.eyebrow", "Бесплатно")}
            </p>
            <h1 className="orbit-hero-design-title-text">{t("catalog.free.hero.title", "Бесплатные сервисы")}</h1>
            <p className="orbit-hero-design-subtitle" style={{ textAlign: "center", marginTop: "var(--orbit-space-sm)" }}>
              {t("catalog.free.hero.body", "Бесплатные точки входа, чтобы начать знакомство с TodayFlow и понять свой следующий шаг.")}
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="orbit-hero-content-block">
        <div className="orbit-hero-content-container">
          ...
          <section className="orbit-card" style={{ background: "rgba(255, 255, 255, 0.95)", boxShadow: "0 4px 16px rgba(0, 0, 0, 0.08)" }}>
            <h2 className="orbit-display-sm">{t("catalog.free.recommendations.title", "С чего можно начать")}</h2>
            <p className="orbit-body-sm orbit-text-muted">{t("catalog.free.recommendations.body", "Бесплатные сервисы, которые быстро вводят в общий контекст.")}</p>
            <CatalogRecommendationGrid slug="free" />
          </section>
          ...
          {/* Callout */}
          <CatalogCallout 
            eyebrow={t("catalog.free.hero.eyebrow", "Бесплатно")}
            title={t("catalog.aside.free.title", "Продолжить знакомство")} 
            body={t("catalog.aside.free.body", "Открой соседние бесплатные сервисы и выбери, куда идти дальше после первого чтения.")} 
          />
        </div>
      </section>
    </main>
