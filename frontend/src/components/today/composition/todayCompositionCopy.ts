...
export const TODAY_COMPOSITION_COPY = {
  ...
  sheetClose: "Закрыть",
  skyStripKicker: "Небо сегодня",
  skyStripOpen: "Открыть небо сегодня — все тела и аспекты",
  skySheetTitle: "Небо сегодня",
  skySheetPositions: "Где находятся",
  skySheetAspects: "Соединения",
