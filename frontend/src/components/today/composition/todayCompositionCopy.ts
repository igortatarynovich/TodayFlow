...
export const TODAY_COMPOSITION_COPY = {
  ...
  journey: {
    ...
    readingLead: "Как прожить этот день: куда тянет, где мягче, что подсвечивает небо и сферы.",
    moveTitle: "Твой ход",
    moveLead: "Цель, практика и опоры — из сегодняшнего контракта и твоего портрета.",
