...
export const TODAY_COMPOSITION_COPY = {
  ...
  journey: {
    dayTitle: "Сюжет дня",
    dayLead: "Одна центральная идея. Карта и число откроешь сам — они станут слоем смысла, не подсказкой заранее.",
    ...
    readingLead:
      "Одна история в главах: небо и драйверы → чего ожидать и ловушка → инструкция → вайб.",
    moveTitle: "Инструкция дня",
    moveLead: "Что делать и чего не делать — из того же конфликта, что в истории дня.",
