...
export const RITUAL_COPY = {
  ...
  tarotGridSub: "Выбери рубашку — через неё карта откроется",
  ...
  tarotGridPickHintPrimary: "Выбери рубашку",
  tarotGridPickHintSecondary: "Карта дня уже определена — жест открывает её.",
  tarotFanHonesty: "Пять рубашек — один жест раскрытия. Карта дня уже определена для тебя сегодня.",
