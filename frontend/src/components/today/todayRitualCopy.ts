...
export const RITUAL_COPY = {
  ...
  tarotIdleHint: "Нажми, чтобы открыть колоду",
  ...
  tarotGridLead: "Карта дня уже собрана",
  tarotGridSub: "Сними верхнюю карту со стопки — как в раскладе Таро",
  /** Одна строка — для узких мест; на экране сетки лучше primary + secondary. */
  tarotGridPickHint: "Это ритуал раскрытия, а не выбор из пяти разных карт.",
  tarotGridPickHintPrimary: "Сними верхнюю карту",
  tarotGridPickHintSecondary: "Карта дня уже определена — жест открывает её.",
  tarotFanHonesty: "Колода как в Таро: сними верхнюю — откроется карта дня, уже собранная для тебя.",
