...
export const TAROT_QUESTION_FLOW_COPY = {
  ...
  concernTitle: "Что сейчас важнее всего?",
  concernBody: "Выберите тему и сразу напишите свой вопрос — или оставьте поле пустым и уточните дальше.",
  concernCustomLabel: "Свой вопрос",
  concernCustomPlaceholder: "Например: стоит ли менять работу?",
  refineStep: "Шаг 2 из 3",
  refineTitle: "Уточните фокус — и при желании поправьте вопрос",
