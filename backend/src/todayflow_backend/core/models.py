...
class TarotFollowUpChip(BaseModel):
    id: str
    label: str
...
class TarotSpreadReading(BaseModel):
    ...
    caution: str = ""
    next_step: str = ""
    synthesis_why: str | None = None
    actions_today: List[str] = Field(default_factory=list)
    self_question: str | None = None
    profile_lens: str | None = None
    profile_lens_applied: bool = False
    insight_holding: str | None = None
    insight_shifting: str | None = None
    insight_attention: str | None = None
    today_suggestion: str | None = None
    follow_up_prompt: str | None = None
    follow_up_chips: List[TarotFollowUpChip] = Field(default_factory=list)
    card_insights: List[TarotCardInsight] = Field(default_factory=list)
...
class EnrichedCompatibilityResponse(BaseModel):
    ...
    funnel_artifact: Optional[Dict[str, Any]] = None
