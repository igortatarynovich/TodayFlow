...
DAY_STORY_PROMPT_VER = "day-story-v1.4-anchor-vibe"
...
- vibe_closing — вайб-концовка (§0.5): 2–4 конкретных, представимых штриха через точку с запятой
  (наушники с шумоподавлением; одно сообщение до обеда; лазурь на манжетах) —
  не благостная фраза («прислушайся к себе»). Не повторяй факты из story.
...
Верни только JSON:
{
  ...
  "abstain": "string",
  "today_move": "string",
  "vibe_closing": "string — 2–4 конкретных штриха через '; '",
