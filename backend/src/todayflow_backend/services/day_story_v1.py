...
DAY_STORY_PROMPT_VER = "day-story-v1"
...
Вход — JSON с фактами: астрология/стержень дня, карта и число ритуала, настроение, профиль (сжато), rhythm_context (цели, привычки, аскезы), intent, behavior_patterns.
...
Тон: живой, тёплый, без «вселенная/поток», без приговора. Опирайся только на факты JSON.
