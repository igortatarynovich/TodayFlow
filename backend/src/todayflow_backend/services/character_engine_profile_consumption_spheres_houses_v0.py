...
_HOUSE_ZONE: dict[int, dict[str, str]] = {
    1: {
        "how": "1 дом: в первом контакте тебя считывают по темпу и дистанции — до знакомства с ядром.",
        "do": "В одном новом контакте отметь первый жест: ближе, дальше или сразу правила?",
    },
    2: {
        "how": "2 дом: твоя самооценка читается через «это моё» — деньги, навыки, право не оправдываться.",
        "do": "Назови одну вещь или навык, который сегодня не отдаёшь «ради мира».",
    },
    3: {
        "how": "3 дом: ты думаешь вслух рядом — учёба, спор, факты для ближайшего круга.",
        "do": "Скажи одно конкретное предложение по делу — без смягчения «никого не задеть».",
    },
    4: {
        "how": "4 дом: дом и приватный ритм — чем ты реально заряжаешься и от чего прячешься.",
        "do": "Сделай дома один завершённый жест восстановления — и отметь начало/конец.",
    },
    5: {
        "how": "5 дом: игра, творчество, риск «ради себя» — не ради роли.",
        "do": "Выдели 20 минут на занятие без пользы для резюме — и не оправдывай его.",
    },
    6: {
        "how": "6 дом: режим тела и мелочей либо держит тебя, либо копится как долг.",
        "do": "Закрой один мелкий бытовой или телесный долг — с явным «готово».",
    },
    7: {
        "how": "7 дом: равные отношения — умеешь ли ты держать явные правила двоих.",
        "do": "Зафиксируй с близким одно правило двоих (время, деньги, доступ) — без намёков.",
    },
    8: {
        "how": "8 дом: совместные ресурсы и необратимые перемены — где контроль спорит с уязвимостью.",
        "do": "Назови себе одну фразой момент, где держишь контроль вместо прямого разговора.",
    },
    9: {
        "how": "9 дом: тебе нужна рамка смысла шире «как сделать» — убеждения, учёба, горизонт.",
        "do": "Запиши одним предложением «зачем этот месяц» — без плана на год.",
    },
    10: {
        "how": "10 дом: публичная роль — по какому следу тебя судят о результате.",
        "do": "Выбери один видимый рабочий результат и доведи до проверяемого «сделано».",
    },
    11: {
        "how": "11 дом: сеть и общее будущее — где взаимный вектор, а где только поддержка контакта.",
        "do": "Напиши одному человеку по конкретному делу — без «просто поддержать связь».",
    },
    12: {
        "how": "12 дом: вне зрителей — либо восстанавливаешься, либо теряешь себя без свидетелей.",
...
_ANGULAR_AUTONOMY_HOW: dict[int, str] = {
    1: "1 дом / первый контакт: сначала проверка, что тебя не переформатируют — потом открытость.",
    4: "4 дом: приватное пространство работает, только если даёт воздух для себя.",
    7: "7 дом: устойчивая связь = отдельные решения без разрыва и без «мы вместо я».",
    10: "10 дом: ты держишься в поле достижений, когда видимость не требует сдать свой метод.",
}
...
def apply_spheres_and_houses_to_payload(
    ...
    *,
    ...
    payload["character_engine_house_lines_v0"] = {
        "projection_version": "character_engine_house_lines_v0.5",
        "identity_thesis": identity_thesis,
        "houses": houses,
        "note": (
            "Thesis how+do on all 12 houses (person-facing; cusp/planet as short tags); "
            "cusp/sign/degree remain Swiss. Long natal prose = Natal Decode opt-in only."
        ),
    }
