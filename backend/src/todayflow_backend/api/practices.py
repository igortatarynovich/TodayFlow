...
GENERAL_PRACTICES = [
    {
        "id": "breathing-4-7-8",
        "title": "Дыхание 4-7-8",
        "description": "Счётный цикл: вдох на 4, пауза на 7, выдох на 8. Если кружится голова — остановитесь и дышите как обычно.",
        "category": "breathing",
        "duration_minutes": 5,
        "difficulty": "beginner",
        "is_free": True,
        ...
        "instructions": [
            ...
            "Если появилось головокружение — остановитесь",
        ]
    },
    {
        "id": "body-scan",
        "title": "Сканирование тела",
        "description": "Лёжа, медленно провести внимание от стоп к макушке и заметить ощущения, ничего не исправляя.",
        "category": "meditation",
        "duration_minutes": 10,
        "difficulty": "beginner",
        "is_free": True,
    ...
    },
    {
        ...
        "description": "Записать три вещи за сегодня, которые получились или которые вы цените — без красивой формулировки.",
        "category": "gratitude",
        "duration_minutes": 5,
        "difficulty": "beginner",
        "is_free": True,
        ...
        "instructions": [
            ...
            "Запишите три вещи за сегодня, которые получились или которые вы цените",
            "Прочитайте список один раз",
            "Закройте заметку",
        ]
    },
    {
        ...
        "description": "Четыре равных шага: вдох, пауза, выдох, пауза. Если пауза неприятна — дышите без задержки.",
        "category": "breathing",
        "duration_minutes": 3,
        "difficulty": "beginner",
        "is_free": True,
        ...
        "instructions": [
            ...
            "Пауза на 4 счета",
            "Повторите 4 цикла",
            "Если кружится голова — уберите паузы и остановитесь",
        ]
    },
    {
        "id": "morning-intention",
        "title": "Утреннее намерение",
        "description": "Одно конкретное намерение на ближайшие часы — не список и не план дня.",
    ...
    },
    {
        ...
        "description": "По очереди пожелать добра себе, близкому человеку, нейтральному человеку и всем вокруг.",
        "category": "meditation",
        "duration_minutes": 15,
    ...
    },
    {
        ...
        "description": "Спокойный цикл: вдох одной ноздрёй, выдох другой. Без усилия и без задержки дыхания.",
        "category": "breathing",
        "duration_minutes": 5,
        "difficulty": "beginner",
        "is_free": True,
    ...
    },
    {
        ...
        "description": "Идти медленнее обычного и держать внимание на стопах. Если мысль увела — вернуться к шагу.",
        "category": "meditation",
        "duration_minutes": 10,
        "difficulty": "beginner",
        "is_free": True,
    ...
    },
    {
        ...
        "title": "Капалабхати",
        "description": "Короткие активные выдохи носом, вдох сам. Не форсируйте. Если закружилась голова — остановитесь.",
        "category": "breathing",
        "duration_minutes": 3,
        "difficulty": "intermediate",
        "is_free": True,
        ...
        "instructions": [
            ...
            "Начните с 10 выдохов, затем отдохните обычным дыханием",
            "Если появилось головокружение — остановитесь",
        ]
    },
    {
        ...
        "description": "Один приём пищи медленнее обычного: сначала посмотреть, потом первый кусок без телефона.",
        "category": "meditation",
        "duration_minutes": 10,
        "difficulty": "beginner",
        "is_free": True,
    ...
    },
    {
        ...
        "description": "Спокойный вдох носом так, чтобы поднимался живот, и более длинный выдох. Без задержки, если она неприятна.",
        "category": "breathing",
        "duration_minutes": 5,
        "difficulty": "beginner",
        "is_free": True,
        ...
        "instructions": [
            ...
            "Вдохните через нос на 4 счета, пусть поднимается живот",
            "Выдохните через рот чуть длиннее вдоха",
            "Повторите 8 раз. Паузу после вдоха пропускайте, если она неприятна",
        ]
    }
]
