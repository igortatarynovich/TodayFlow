...
class LearningService:
    ...
    def build_user_learning_context(
        ...
        *,
        ...
        psychotype = self._build_psychotype_summary(feedback_summary, diary_summary, signal_summary)
        return {
    ...
    def _build_psychotype_summary(
        ...
        summary = f"{response_style} {support_style}{lane_line}{topic_line}".strip()
        return {
            "summary": summary,
